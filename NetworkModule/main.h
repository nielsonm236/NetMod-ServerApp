...
#define MQTT_START_VERIFY_SUBSCRIBE1    7
#define MQTT_START_QUEUE_SUBSCRIBE2	8
#define MQTT_START_VERIFY_SUBSCRIBE2    9
#define MQTT_START_QUEUE_SUBSCRIBE3	10
#define MQTT_START_VERIFY_SUBSCRIBE3    11
#define MQTT_START_QUEUE_SUBSCRIBE4	12
#define MQTT_START_VERIFY_SUBSCRIBE4    13
#define MQTT_START_QUEUE_PUBLISH_ON	14
#define MQTT_START_QUEUE_PUBLISH_AUTO   15
#define MQTT_START_QUEUE_PUBLISH_PINS	16
